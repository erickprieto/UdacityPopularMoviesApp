 ...
 * <p>
 * These Endpoints download a JSON object {@link PageResultVideosTO} that contains
 * a List of {@link com.udacity.popularmovies.net.contracts.TO.VideoTO}.
 *
...
public interface VideoServiceContract {
     ...
     * @return <code>PageResultVideosTO</code> details of response with inside a List of
     * {@link com.udacity.popularmovies.net.contracts.TO.VideoTO}
     */
